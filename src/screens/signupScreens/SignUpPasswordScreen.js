            ...
            <View style={signinStyles.container}>
                <View style={signinStyles.sectionOne}>
                    <View style={styles.welcomeSection}>
                        <Text style={styles.headerBlue}>Create a password,</Text>
                        <Text style={mainStyles.subText}>Passwords require one lowercase, uppercase, number and special character </Text>
                    </View>
                </View>
                <View style={signinStyles.sectionTwo}>
                    <View style={styles.row}>
                        <Image
                            ...
                            source={require('../../../assets/signinAssets/lockGreen.png')}
                        />
                        <TextInput s
                    ...
                    <View style={styles.secondaryOptions}>
                        ...
                        >
                            ...
                            <View style={signinStyles.backLineButton}>
                                <FontAwesome name="arrow-left" size={22} color="#FDBA02" style={{ paddingRight: 5, paddingBottom: 5, }} />
                                <Text style={mainStyles.mdYellowText}>back</Text>
                            </View>
                        </TouchableOpacity>
